...
class App{
  ...
  _newWorkout(e) {
    ...
    const { lat, lng } = thid.#mapEvent.latlng;

    L.marker([ lat, lng ]).addtop(this.#map).bindPopup(L.popup({maxWidth: 250, minWidth: 100, autoClose: false, closeOnClick: false, className: "running-popup", 
